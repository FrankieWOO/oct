...
%
% [l, l_x, l_xx, l_u, l_uu, l_ux] = fn_cost_reaching_task_1dof_plants ( x, u, t, w, xt, fnTorque )
%
...
%
function [l, l_x, l_xx, l_u, l_uu, l_ux] = j_reaching_task_1dof_plants ( x, u, t, p )

fl = @( x, u, t ) l_reaching_task_1dof_plants ( x, u, t, p );
l  = fl ( x, u, t );
